...
int main() // la variable principal del programa de inicializacion
{
    ...
    printf("---Esta es la Matriz A---"); // se genera la matriz A con numeros aleatorios
    ...
    sumamatrix(fila, columna, matrixA, matrixB, matrixS); // Llamamos a la función para sumar las matrices A y B
    printf("\n");
